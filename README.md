...
Submitted for consideration for publication in *PLOS Computational Biology*.
</br>
...
### References
Ahn, S., Grimes, T. and Datta, S (2023). [A pseudo-value regression approach for differential network analysis of co-expression data](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-022-05123-w). *BMC Bioinformatics*, **24**, 8. </br></br>
